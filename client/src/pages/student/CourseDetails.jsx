...
const CourseDetails = () => {
  ...
  // useEffect(() => {
  //   if(userData && courseData && Array.isArray(userData.enrollCourses)) {
  ...
  useEffect(() => {
    if (userData && courseData && Array.isArray(userData.enrolledCourses)) {
      const enrolledIds = userData.enrolledCourses.map((course) =>
        typeof course === 'object' && course.$oid ? course.$oid : course
      );
      setIsAlreadyEnrolled(enrolledIds.includes(courseData._id));
    }
  }, [userData, courseData]);
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div
          className="absolute top-0 left-0 w-full -z-[-1] bg-gradient-to-b from-cyan-100/70"
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
              ...
              <button onClick={enrollCourse} className="md:mt-6 mt-4 w-full py-3 rouned bg-blue-600 text-white font-medium">{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
              <div className="pt-6">
